// Welcome to the main Seb script
...
document.addEventListener("visibilitychange", handleTabLeave)
           ...
           <div class="loader">
  <div>Seb is loading your content!</div>
  <div style='font-size:35px;'>Please wait while the seb is working!</div>
  <div class="b1"></div> 
  <div class="b2"></div>
  <div class="b3"></div>
</div> 
